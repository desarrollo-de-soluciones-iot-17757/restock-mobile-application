...
class BatchTransferBloc extends Bloc<BatchTransferEvent, BatchTransferState> {
  ...
  FutureOr<void> _onStarted(
    ...
    try {
      ...
      final accountBranches = await branchFacadeService.getBranchesByAccountId();
      ...
      final availableBranches = accountBranches.where((branch) => branch.branchId != activeBranchId).toList();

      // Fetch the batches for the active branch
      final availableBatches = await batchFacadeService.getBatchesForActiveBranch();
  ...
  FutureOr<void> _onSubmitted(
    ...
    try {
      ...
      final batchId = submittedState.selectedBatch!.branchId;
